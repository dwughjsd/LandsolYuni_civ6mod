...
<AssetObjects..TextureInstance>
	...
	<m_SourceFilePath text="D:\Documents\Firaxis ModBuddy\LandsolKokkoro\LEADER_NATSUME_KOKORO_PRINCESS_WORKAROUND.png"/>
	<m_SourceObjectName text=""/>
	<m_ImportedTime>0</m_ImportedTime>
	<m_ExportedTime>1306898076</m_ExportedTime>
	<m_ClassName text="UserInterface"/>
	<m_DataFiles>
		<Element>
			<m_ID text="DDS"/>
			<m_RelativePath text="LEADER_NATSUME_KOKORO_PRINCESS_WORKAROUND.dds"/>
		</Element>
	</m_DataFiles>
	<m_Name text="LEADER_NATSUME_KOKORO_PRINCESS_WORKAROUND"/>
	<m_Description text=""/>
	<m_Tags>
