...
<AssetObjects..GeometryInstance>
	...
	<m_DataFiles>
		<Element>
			<m_ID text="GR2"/>
			<m_RelativePath text="LEAD_LANS_KokkoroPrincess.fgx"/>
		</Element>
		<Element>
			<m_ID text="WIG"/>
			<m_RelativePath text="LEAD_LANS_KokkoroPrincess.wig"/>
		</Element>
	</m_DataFiles>
	<m_Name text="LEAD_LANS_KokkoroPrincess"/>
	<m_Description text="LEAD_LANS_KokkoroPrincess"/>
	<m_Tags>
		<Element text="Leader"/>
	</m_Tags>
</AssetObjects..GeometryInstance>
