...
function OnLoadScreenContentReady()
	...
	if playerConfig == nil then
		...
		for _, item in ipairs(uniqueAbilities) do
			...
			if (item.Name ~= nil and item.Name ~= "NONE" and string.find(item.Name,"_HIDE_ON_LOAD") == nil) then
			...
			if (item.Description ~= nil and item.Description ~= "NONE" and string.find(item.Name,"_HIDE_ON_LOAD") == nil) then
