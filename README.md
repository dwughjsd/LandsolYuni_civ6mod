...
It's recommended to set your Wwise project to Generate Per Bank Metadata File (in `Project/Project Settings/Soundbanks` or simple press `Shift+K` and switch to `Soundbanks` tab).
